...
tests/test_glm53_bf16_rocm.o: tests/test_glm53_bf16_rocm.c ds4_gpu.h
	$(CC) $(filter-out -ffast-math,$(CFLAGS)) $(ROCM_HOST_CFLAGS) -DDS4_ROCM_BUILD -I. -c -o $@ $<

tests/test_glm53_bf16_rocm: tests/test_glm53_bf16_rocm.o ds4_rocm.o ds4_image.o tests/test_rocm_engine_stub.o $(ROCM_MMQ_OBJS)
	$(HIPCC) $(ROCM_CFLAGS) -o $@ $^ $(ROCM_LDLIBS)

.PHONY: test-glm53-bf16-rocm
test-glm53-bf16-rocm: tests/test_glm53_bf16_rocm
	./tests/test_glm53_bf16_rocm
